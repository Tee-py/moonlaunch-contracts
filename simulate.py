...
INIT_VIRTUAL_TOKEN_RESERVE = 1_073_000_000 * 10**18
...
def calculate_y_v1(target_mcap: float, init_virtual_token_reserve: float, init_real_token_reserve: float):
    return (target_mcap * (init_virtual_token_reserve - init_real_token_reserve))/init_real_token_reserve

def calculate_z_v1(target_mcap: float, init_virtual_token_reserve: float, init_real_token_reserve: float):
    return (target_mcap * (init_virtual_token_reserve - init_real_token_reserve) * init_virtual_token_reserve)/init_real_token_reserve
...
#     init_virtual_eth_reserve = calculate_y_v1(target_mcap_in_core, INIT_VIRTUAL_TOKEN_RESERVE, INIT_REAL_TOKEN_RESERVE)
...
def calculate_token_variables(target_mcap_usd: float):
    target_mcap_in_core = target_mcap_usd
    # init_virtual_token_reserve = (start_price_core * INIT_REAL_TOKEN_RESERVE/target_mcap_in_core)
    # init_virtual_eth_reserve = start_price_core * init_virtual_token_reserve
    # curve_constant = init_virtual_token_reserve * init_virtual_eth_reserve
    init_virtual_eth_reserve = calculate_y_v1(target_mcap_in_core, INIT_VIRTUAL_TOKEN_RESERVE, INIT_REAL_TOKEN_RESERVE)
    curve_constant = calculate_z_v1(target_mcap_in_core, INIT_VIRTUAL_TOKEN_RESERVE, INIT_REAL_TOKEN_RESERVE)
    return {
        "curve_constant": curve_constant,
        "init_virtual_token_reserve": INIT_VIRTUAL_TOKEN_RESERVE,
        "init_virtual_eth_reserve": init_virtual_eth_reserve,
...
token_variables = calculate_token_variables(2000_000*10**18)
