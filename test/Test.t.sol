...
contract MainnetForkTest is Test {
    ...
    // function test_calculate_token_curve_variables(uint256 startPrice, uint256 targetMCap) public view {
    //     startPrice = bound(startPrice, 0.0000001 ether, 1000000 ether);
    //     targetMCap = bound(targetMCap, 5_000 ether, 1_000_000_000 ether);
    ...
    //         uint256 afterVirtualEthReserve, uint256 curveConstant,, uint256 lastPrice, uint256 lastMcapInEth,
    //         ,,, bool migrated
    //     ) = curve.tokenPool(address(testToken));
    //     assertEq(migrated, false);
    ...
    //     assertEq(virtualTokenReserve, curveConstant / afterVirtualEthReserve);
    ...
    //     });
    //     vm.prank(msg.sender);
    //     curve.launchToken(param, 0.1 ether, 10_000 ether);
    // }
